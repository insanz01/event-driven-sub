...
export const departmentDTOMapper = (
	department: DepartmentDTOMapper,
): DepartmentDTO => {
	...
	return {
		...
		departmentManagement: department.DepartmentManagement.map(
...
export const departmentsDTOMapper = (
	departments: DepartmentDTOMapper[],
): DepartmentDTO[] => {
